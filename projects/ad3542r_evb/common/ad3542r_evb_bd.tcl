...
create_bd_port -dir I -from 1 -to 0 dac_spi_sdi
create_bd_port -dir O -from 1 -to 0 dac_spi_sdo
...
ad_ip_instance axi_ad3542r axi_ad3542r_dac

ad_connect axi_ad3542r_dac/dac_sclk       dac_sclk
ad_connect axi_ad3542r_dac/dac_csn        dac_csn
ad_connect axi_ad3542r_dac/sdio_i         dac_spi_sdi
ad_connect axi_ad3542r_dac/sdio_o         dac_spi_sdo
ad_connect axi_ad3542r_dac/sdio_t         dac_spi_sdo_t
ad_connect axi_ad3542r_dac/dma_data       axi_dac_dma/m_axis_data
ad_connect axi_ad3542r_dac/valid_in_dma   axi_dac_dma/m_axis_valid
ad_connect axi_ad3542r_dac/dac_data_ready axi_dac_dma/m_axis_ready
ad_connect sys_rstgen/peripheral_aresetn  axi_dac_dma/m_src_axi_aresetn

# Tie unused inputs to GND

ad_connect axi_ad3542r_dac/valid_in_dma_sec GND
ad_connect axi_ad3542r_dac/data_in_a GND
ad_connect axi_ad3542r_dac/data_in_b GND
ad_connect axi_ad3542r_dac/valid_in_a GND
ad_connect axi_ad3542r_dac/valid_in_b GND
ad_connect axi_ad3542r_dac/external_sync GND
...
ad_cpu_interconnect 0x44a70000 axi_ad3542r_dac
